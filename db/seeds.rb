...
clients_data = [
  {
    ...
    support_needs: 'Daily living support and transport to medical appointments',
  ...
  },
  {
    ...
    support_needs: 'Regular wellbeing check-ins and social connection',
    medication: 'None',
    allergies: 'Shellfish',
  ...
  },
  {
    ...
    support_needs: 'Physical therapy exercises, blood sugar monitoring, transport to appointments',
  ...
  },
  {
    ...
    support_needs: 'Community access support — markets, libraries, local events',
  ...
  },
  {
    ...
    support_needs: 'Flexible scheduling around study — help staying organised and social',
  ...
  },
  {
    ...
    support_needs: 'Support with specific tasks and occasional community access — direct communication preferred',
    medication: 'None',
    allergies: 'None',
  ...
  },
  {
    ...
    support_needs: 'Cognitive engagement — gardening, chess, conversation; keeping mind active',
